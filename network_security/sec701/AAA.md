...
بعد الاوثينتيكيشن، النظام يحدد للمستخدم:
  - أي الموارد يقدر يدخلها
  - وأي العمليات مسموح له يعملها  

**مثال**:
 
"المستخدم سعيد مسموح له يدخل على سيرفر 2 مثلا باستخدام SSH فقط."
...
**الفائدة**:
 ...
 تتبع كيفية استخدام موارد الشبكة.  
**مثال**:

 "المستخدم سعيد دخل على سيرفر 2 باستخدام SSH لمدة 15 دقيقة."
...
بيوفر طريقتين أساسيتين لتطبيق خدمات الترييبل اي:
